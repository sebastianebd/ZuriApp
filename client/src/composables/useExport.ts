...
export function useExport() {
  ...
  return {
    exportReplacementToPDF,
    exportHistoryToPDF,
    exportUsersToPDF: (users: User[]) => {
      const doc = new jsPDF()
    ...
    exportAuditToPDF: (logs: AuditLog[], filters: any) => {
      const doc = new jsPDF()
    ...
    exportAuditToExcel: (logs: AuditLog[]) => {
